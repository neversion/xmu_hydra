...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field solr_name('carrier_type', :stored_searchable, type: :string), :label => '载体:'
    ...
    config.add_show_field solr_name('uniform_resource_locator', :displayable, type: :string), :label => 'URL:'
    config.add_show_field solr_name('date_of_publication', :stored_sortable, type: :date), :label => '出版时间:'
    ...
    config.add_show_field solr_name('duration', :displayable, type: :integer), :label => '时长:'
    config.add_show_field solr_name('dimensions', :displayable, type: :string), :label => 'dimensions:'
    config.add_show_field solr_name('performer_narrator_presenter', :stored_searchable, type: :string), :label => 'performer_narrator_presenter:'
    config.add_show_field solr_name('relationship_designaor', :stored_searchable, type: :string), :label => 'relationship_designaor:'
    config.add_show_field solr_name('contributor', :stored_searchable, type: :string), :label => '贡献者:'
    config.add_show_field solr_name('language_of_content', :displayable, type: :string), :label => '语言:'
    config.add_show_field solr_name('upload_date', :displayable, type: :string), :label => '上传时间:'
