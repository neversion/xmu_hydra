...
describe GenericItemsController do
  ...
  # GenericItem. As you add validations to GenericItem, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "title" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # GenericItemsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all generic_items as @generic_items" do
      generic_item = GenericItem.create! valid_attributes
      get :index, {}, valid_session
      assigns(:generic_items).should eq([generic_item])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved generic_item as @generic_item" do
        ...
        post :create, {:generic_item => { "title" => "invalid value" }}, valid_session
        assigns(:generic_item).should be_a_new(GenericItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested generic_item" do
        ...
        GenericItem.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => generic_item.to_param, :generic_item => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the generic_item as @generic_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        GenericItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => generic_item.to_param, :generic_item => { "title" => "invalid value" }}, valid_session
        assigns(:generic_item).should eq(generic_item)
      end
